...
\begin{frame}
    ...
    \include{head_sorted_218_arules_by_lift}
\end{frame}
\begin{frame}
    \frametitle{Arules für supp=0.001, Top 10 Support}
    \include{head_sorted_218_arules_by_support}
\end{frame}
\begin{frame}
    \frametitle{Arules für supp=0.001, Top 10 Confidence}
    \include{head_sorted_218_arules_by_confidence}
\end{frame}
\begin{frame}
